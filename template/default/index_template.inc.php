...
<!-- load style -->
<link rel="shortcut icon" href="img/logo_itsk.png" type="image/x-icon" />
...
<body>
  ...
  <div class="navbar navbar-social navbar-fixed-top">
    <div class="navbar-inner">
      <div class="container">
        ...
        <ul class="nav">
          <li><a href="http://itsk-soepraoen.ac.id/" target="_blank">ITSK Soepraoen</a></li>
          <li><a href="https://fppti-jatim.or.id/">FPPTI Jatim</a></li>
          <li><a href="http://e-resource.pnri.go.id">E-Resource PNRI</a></li>
          <li><a href="https://jurnal.poltekkes-soepraoen.ac.id/">Jurnal Online</a></li>
          <li class="dropdown"><a href="">Jurnal Eksternal</a>
            <ul class="dropdown-content">
              <li><a href="http://jurnal.unipasby.ac.id/index.php/embrio">Jurnal Embrio </a></li>
              <li><a href="https://jurnalbidankestrad.com/index.php/jkk">Jurnal Kebidanan Dan Kesehatan Tradisional</a></li>
              <li><a href="https://obgyn.onlinelibrary.wiley.com/journal/14710528">Jurnal Internasional BJOG</a></li>
              <li><a href="https://thejmch.com/">Maternal and Child Health Journal</a></li>
            </ul>
          </li>
  ...
  <!--// Menu //-->
  <div class="navbar navbar-menu navbar-fixed-top" style="margin-top: -40px; margin-bottom: -40px;">
    <div class="navbar-inner">
      <div class="container">
        ...
        <a class="brand" href="index.php">
         <div class="sitename" style="font-size:18px;"><?php echo $sysconf['library_name']; ?></div>
         <div class="subname" style="font-size:12px;"><?php echo $sysconf['library_subname']; ?></div>
        </a>
...
<div class="footer">
    <div class="container">
        <div class="row">
            ...
            <div class="span2 lisence">
                <div id="histats_counter"></div>
            </div>
            <div class="span8 lisence">
...
jQuery(function($){
  $.supersized(
  {
    ...
    {image : '<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/img/2b.jpg'},
    {image : '<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/img/1a.jpg'}
    ]
  });
});
...
_Hasync.push(['Histats.start', '1,4582136,4,27,120,50,00001000']);
...
<noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?4582136&101" alt="web stats" border="0"></a></noscript>
<!-- Histats.com  END  -->
</body>
</html>
